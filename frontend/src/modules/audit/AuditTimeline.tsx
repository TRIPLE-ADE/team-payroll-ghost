...
export function AuditTimeline() {
  const { data, isPending, isError, error, isFetching } = useAuditEvents();
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <ol className="relative space-y-0 border-l border-zinc-800 pl-6">
        {isPending ? (
          <li className="relative pb-6 pl-2 text-sm text-zinc-500">
          ...
          <li className="relative pb-6 pl-2 text-sm text-red-400">
            <span className="absolute left-[-29px] top-1.5 flex h-3 w-3 items-center justify-center rounded-full border border-red-900/60 bg-zinc-950">
